...
public class TxCompletionOnNodeStopTest extends GridCommonAbstractTest {
     ...
     */
    public void dotestTxOnStopTimeout() throws Exception {
    ...
    private void doTestTxCompletionOnStop(boolean client) throws Exception {
        ...
        TestCommunicationSpi.print = true;
        ...
        IgniteInternalFuture<Long> txsFut = GridTestUtils.runMultiThreadedAsync(() -> {
            ...
            /*try (*/Transaction tx = ignite.transactions()
                .txStart(txMode.get1(), txMode.get2(), 15_000, TX_SIZE);/*) {*/
...
//                }
        ...
        TestCommunicationSpi.print = false;
    ...
    private static class TestCommunicationSpi extends TcpCommunicationSpi {
        ...
        @Override public void sendMessage(
            ...
            if (print && msg instanceof GridIoMessage) {
                ...
                if(msg0 instanceof GridDistributedBaseMessage){
                    ...
                    IgniteInternalTx tx = ((IgniteEx)ignite).context().cache().context().tm().tx(((GridDistributedBaseMessage)msg0).version());
                ...
                System.out.println(
                    String.format("Output msg[type=%s, fromNode= %s, toNode=%s, concurrency=%s, isolation=%s]",
                        msg0.getClass().getSimpleName(),
                        locNodeId.substring(33),
                        id.substring(33),
                        concurrency,
                        isolation)
                );
